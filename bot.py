...
# Persistent state file (STREAK + LAST_LIST_USE survive bot restarts)
STATE_FILE = os.path.join(os.path.dirname(__file__), "bot_state.json")


def load_state() -> None:
    global STREAK, LAST_LIST_USE
    try:
        ...
        print(f"[INFO] Loaded state: streak={STREAK}, {len(LAST_LIST_USE)} user(s) tracked")
